...
### � Início Rápido
- **[⚡ Exemplos Rápidos](./exemplos_rapidos.md)** - Guia prático para iniciantes
- **[🌟 Exemplos Avançados](./exemplos_avancados.md)** - Casos empresariais e cenários complexos
...
<div class="card group">
  ...
  <div class="card-body">
    <p class="card-text">Conteúdo do card com suporte completo a dark mode e responsividade.</p>
  </div>
