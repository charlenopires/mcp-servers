#!/usr/bin/env python3
"""
Servidor MCP: sistema de análise de vendas_server
...
mcp = FastMCP("sistema de análise de vendas_server")
...
if __name__ == "__main__":
    logger.info("Iniciando servidor sistema de análise de vendas_server...")
    mcp.run()
