#!/usr/bin/env python3
"""
Servidor MCP: sistema de gestão completo_server
...
mcp = FastMCP("sistema de gestão completo_server")
...
if __name__ == "__main__":
    logger.info("Iniciando servidor sistema de gestão completo_server...")
    mcp.run()
